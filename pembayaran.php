...
nav.bottom-nav a, nav.bottom-nav button{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;color:#475569;text-decoration:none;font-size:12px;width:20%;background:transparent;border:0}
...
<div class="container">
  ...
  <section id="pendaftar" class="mt-4">
    ...
    <!-- Mobile Cards -->
    <div id="pendaftarCardContainer" class="mb-2"></div>
...
navDownload.addEventListener("click", function(e){
    e.preventDefault();
    modal.classList.remove("hidden");
});
cancelBtn.addEventListener("click", function(){ modal.classList.add("hidden"); });
confirmBtn.addEventListener("click", function(){ modal.classList.add("hidden"); downloadExcelAdvanced(); });
